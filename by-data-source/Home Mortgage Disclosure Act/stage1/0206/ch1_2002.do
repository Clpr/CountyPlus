...
/* DATA READING ***************************************************************/
{
	local RAWPATH = "${RAWDATA_FOLDER_0206}/2002 LAR"
	local ZIPFILE = "HMS.U2002.LARS.zip"
	local UNZIPED = "HMS.U2002.LARS"
...
/* VARIABLE LABELLING *********************************************************/
{
    ...
    la var id                  "respondent/lender ID, unique within agency e.g. FDIC, OCC"
...
/* VALUE LABELING *************************************************************/
{
	...
	* define: full FIPS
	...
	capture : destring state_code, replace force
...
/* SAVE ***********************************************************************/
save "${OUTPUT_FOLDER}/raw2002.dta", replace
...
/* AGGREGATION ****************************************************************/
{
	...
	use "${OUTPUT_FOLDER}/raw2002.dta", clear
...
/* SLICE & SAVE ***************************************************************/
{
	...
	save "${OUTPUT_FOLDER}/final2002.dta", replace
}
