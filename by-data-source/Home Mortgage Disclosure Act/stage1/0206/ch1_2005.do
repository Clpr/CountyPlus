...
/* DATA READING ***************************************************************/
{
	local RAWPATH = "${RAWDATA_FOLDER}/HMDA 02-06 ultimate LAR/2005 LAR"
	local ZIPFILE = "LARS.ULTIMATE.2005.DAT.zip"
	local UNZIPED = "LARS.ULTIMATE.2005.DAT"
...
/* SAVE ***********************************************************************/
save "${OUTPUT_FOLDER}/raw2005.dta", replace
...
/* AGGREGATION ****************************************************************/
{
	...
	use "${OUTPUT_FOLDER}/raw2005.dta", clear
...
/* SLICE & SAVE ***************************************************************/
{
	...
	save "${OUTPUT_FOLDER}/final2005.dta", replace
}
