...
/* DATA READING ***************************************************************/
{
	local RAWPATH = "${RAWDATA_FOLDER}/HMDA 02-06 ultimate LAR/2006 LAR"
	local ZIPFILE = "LARS.ULTIMATE.2006.DAT.zip"
	local UNZIPED = "LARS.ULTIMATE.2006.DAT"
...
/* SAVE ***********************************************************************/
save "${OUTPUT_FOLDER}/raw2006.dta", replace
...
/* AGGREGATION ****************************************************************/
{
	...
	use "${OUTPUT_FOLDER}/raw2006.dta", clear
...
/* SLICE & SAVE ***************************************************************/
{
	...
	save "${OUTPUT_FOLDER}/final2006.dta", replace
}
